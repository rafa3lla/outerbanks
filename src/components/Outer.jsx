import outer from "/outer.jpeg"

export default function Outer() {
    return(
        <section className="">
            <h2 className="text-3xl font-bold text-red-900"> Série Outer Banks</h2>
            <img className="mb-3 flex justify-items-center" src={outer} alt="imagem outer banks" />
            <p className="text-pink-950">Outer Banks
            ...
            <a className="text-2xl text-yellow-800" href="https://www.netflix.com/br/">Clique aqui para fazer sua assinatura na Netflix!</a>
        </section>
    )
}